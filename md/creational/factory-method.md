...
obtener la clase correcta según sea el caso. Código [Factory Method](https://github.com/sauljabin/java-design-patterns/tree/main/src/main/java/pattern/creational/factorymethod).
